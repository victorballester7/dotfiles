...
function show_volume_notif {
    ...
    if [[ $show_music_in_volume_indicator == "true" ]]; then
        ...
        notify-send -t $notification_timeout -h string:x-dunst-stack-tag:media -h int:value:$volume -i "$album_art" "$volume_icon $volume%" "$current_song"
    else
        notify-send -t $notification_timeout -h string:x-dunst-stack-tag:media -h int:value:$volume "$volume_icon $volume%"
    fi
}
...
function show_music_notif {
    ...
    notify-send -t $notification_timeout -h string:x-dunst-stack-tag:media -i "$album_art" "$song_title" "$song_artist - $song_album"
}
...
function show_mic_notif {
    ...
    notify-send -t $notification_timeout -h string:x-dunst-stack-tag:media -h int:value:$volume "$mic_icon $volume%"
}
...
function show_brightness_notif {
    ...
    get_brightness_icon
    notify-send -t $notification_timeout -h string:x-dunst-stack-tag:media -h int:value:$brightness "$brightness_icon $brightness%"
}
